...
__DEFINE__(1679646004412, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1679646004413,"./event-store":1679646004414}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679646004413, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1679646004414, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1679646004413,"./utils":1679646004415}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1679646004415, function(require, module, exports) {
...
return __REQUIRE__(1679646004412);
})()
