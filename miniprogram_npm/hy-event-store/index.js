...
__DEFINE__(1647431060977, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1647431060978,"./event-store":1647431060979}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647431060978, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1647431060979, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1647431060978,"./utils":1647431060980}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1647431060980, function(require, module, exports) {
...
return __REQUIRE__(1647431060977);
})()
